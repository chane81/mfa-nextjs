...
| 증상                                                       | 항목                                                                                                                                              |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `_jsxDEV is not a function` (dev, catalog 첫 로드)         | [0-4c](#0-4c-콜드-dev-첫-로드에서-jsxdev-is-not-a-function)                                                                                       |
...
| 증상                                      | 항목                                                                                                                                                   |
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| env 를 바꿨는데 조용히 무시됨             | `turbo.json` 의 `globalEnv` 미등록 — [A-10](#a-10-turbo-가-등록-안-된-환경변수를-걸러낸다), [B-8](#b-8-a-10-을-또-밟았다-waitforremotestimeout-미등록) |
